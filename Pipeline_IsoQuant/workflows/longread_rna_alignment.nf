...
workflow LONGREAD_RNA {
    ...
    // ch_filter_rules = Channel.value(file("${projectDir}/assets/filtering.json")) // Only used in Sqanti3
    ...
    /*
    // 3. Skip grouping: directly feed each BAM per sample into IsoQuant
